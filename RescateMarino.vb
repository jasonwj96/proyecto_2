Public Class RescateMarino
    ...
    Private Sub tmr_swimmer_move_Tick(sender As Object, e As EventArgs) Handles tmr_swimmer_move.Tick
        ...
        For Each shark As Swimmer In vpic_sharks
            If shark.Location.X >= X_LEFT_BOUND + SAFEZONE_PADDING And
                shark.Location.X <= X_RIGHT_BOUND - SWIMMER_SPRITE_SIZE - SAFEZONE_PADDING And
                shark.Location.Y >= Y_TOP_BOUND + SAFEZONE_PADDING And
            ...
            If shark.entered_bounds Then
                ...
                If shark.Location.Y <= Y_TOP_BOUND Or
                    shark.Location.Y >= Y_BOTTOM_BOUND - SWIMMER_SPRITE_SIZE - TITLEBAR_HEIGHT - 10 Then
    ...
    Private Sub Stop_Game()
        tmr_game.Enabled = False
        tmr_swimmer_spawn.Enabled = False
