Public Class Vehicle
    ...
    Private _max_fuel As Integer = 500 'Tamaño en pixeles de la barra de combustible
    Private _current_fuel As Integer = 500 'Tamaño en pixeles de la barra de combustible
